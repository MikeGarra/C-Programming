...
int main() {
    ...
    //cout << first_name; - Will display garbabge!
...
//    cout << "Your last name, " << last_name << " has " << strlen(last_name)
//         << " characters." << endl;
//    
...
//    cout << "-----------------------------------" << endl;
//    //This will only print out the first name in 'full_name'
//    cout << "Enter your full name: ";
//    cin >> full_name;
//    cout << "Your full name is: " << full_name << endl;
    
    cout << "Enter your full name: ";
    //Allows for the program to display the full name with all the characters
